...
<head>
    ...
    <title>Arribos del dia - Administración</title>
    <!-- InstanceEndEditable -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
        	...
        	<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><!-- InstanceBeginEditable name="titulo" -->Check in<!-- InstanceEndEditable --></h1>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="glyphicon glyphicon-circle-arrow-down"></i> Arribos del dia</h3>
                        </div>
...
<?php
if (!isset($qty_rsv)) {
    echo '<tr><td colspan="8" class="text-center">'; sinDatos(); echo '</td></tr>';
}else {
    for ($i=0; $i < $qty_rsv; $i++) { 
        echo '<tr>';
        foreach ($titulos_checkin as $a) {
            if ($a == 0) {
                continue;
            }else if ($a == 20) {
...
?>                                          
                            ...
                            <div class="text-right">
                                <a href="reservations.php">Ver arribos de otro dia <i class="glyphicon glyphicon-circle-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
			...
			<div class="row">
                <div class="col-lg-6">
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="glyphicon glyphicon-stats"></i> Habitaciones ocupadas
						</div>
						<div class="panel-body">
							<div id="morris-donut-chart"></div>
							<a href="#" class="btn btn-default btn-block">Ver detalle</a>
						</div>
						<!-- /.panel-body -->
					</div>				
				</div>
                ...
                <div class="col-lg-6">
					<div class="panel panel-default">
						<div class="panel-heading">
							<i class="glyphicon glyphicon-bullhorn"></i> Recordatorios importantes
						</div>
						<div class="panel-body">
<?php
if (!isset($qty_rsv)) {
    echo '<h6>'; sinDatos(); echo'</h6>';
}else {
    for ($i=0; $i < $qty_rsv; $i++) { 
        if ($filas[$titulos_columnas[14]][$i] == '') {
            continue;
        }else {
            echo '<div class="alert alert-warning">
                      <strong>'.$filas[$titulos_columnas[3]][$i].'!</strong> '.$filas[$titulos_columnas[14]][$i].'
                    </div>';
        }
    }
}
