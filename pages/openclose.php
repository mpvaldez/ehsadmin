...
<head>
    ...
    <title>Abrir y cerrar habitaciones - Administración</title>
    <!-- InstanceEndEditable -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
        	...
        	<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><!-- InstanceBeginEditable name="titulo" -->Disponibilidad<small> Abrir y cerrar habitaciones</small><!-- InstanceEndEditable --></h1>
                </div>
            </div>
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Abrir / Cerrar</h3>
                        </div>
                        <!-- Heading del panel -->

                        <div class="panel-body">
                            <form action="../controller/indiv_controller.php" id="formulario" class="" method="POST">
                                <input type="hidden" name="columna" value="cerrado">
