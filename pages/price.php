...
<head>
    ...
    <title>Modificar precios - Administración</title>
    <!-- InstanceEndEditable -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
        	...
        	<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><!-- InstanceBeginEditable name="titulo" -->Disponibilidad<small> Modificar precios</small><!-- InstanceEndEditable --></h1>
                </div>
            </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="../controller/indiv_controller.php" id="formulario" class="" method="POST">
                                <input type="hidden" name="columna" value="tstandard">
...
?>                                               
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <p><b>Tarifa</b></p>
                                            <input class="form-control" name="element" type="text" placeholder="0.00">
                                        </div>
                                    </div>
                                </div>
                                <!-- Precio -->
