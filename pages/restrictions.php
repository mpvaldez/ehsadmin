...
<head>
    ...
    <title>Modificar restricciones - Administración</title>
    <!-- InstanceEndEditable -->
...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
        	...
        	<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><!-- InstanceBeginEditable name="titulo" -->Disponibilidad<small> Modificar restricciones</small><!-- InstanceEndEditable --></h1>
                </div>
            </div>
