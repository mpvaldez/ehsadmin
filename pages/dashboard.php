...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
        	...
        	<div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><!-- InstanceBeginEditable name="titulo" -->Dashboard <small> Resumen del dia</small><!-- InstanceEndEditable --></h1>
                </div>
            </div>
                    ...
                    <div class="panel panel-green">
                        <div class="panel-heading">
                            <a href="checkin.php">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <i class="glyphicon glyphicon-circle-arrow-down fa-5x"></i>
                                    </div>
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $numero_en_cuadro['verde']?></div>
                                        <div>Check in</div>
                                    </div>
                                </div>
                    ...
                    <div class="panel panel-red">
                        <div class="panel-heading">
                            <a href="checkout.php">
                                <div class="row">
                                    <div class="col-xs-3">
                                        <i class="glyphicon glyphicon-circle-arrow-up fa-5x"></i>
                                    </div>
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $numero_en_cuadro['rojo']?></div>
                                        <div>Check-out</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                        ...
                        <div class="panel-heading">
                            <a href="reservations.php">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $numero_en_cuadro['amarillo']?></div>
                                        <div>Reservas</div>
                                    </div>
                                </div>
                                <div class="clearfix"></div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Reservas registradas en el mes
                        </div>
                        <!-- /.panel-heading -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="glyphicon glyphicon-bell fa-fw"></i> Reservas registradas en el dia</h3>
                        </div>
                        <div class="panel-body">
...
?>                                     
                            ...
                            <div class="text-right">
                                <a href="reservations.php">Ver reporte completo <i class="glyphicon glyphicon-circle-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
